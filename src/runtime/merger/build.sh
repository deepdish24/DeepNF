...
g++ -std=c++11 -I//.linuxbrew/Cellar/nlohmann_json/3.1.2/include NF.cpp Field.cpp packet.cpp RuntimeNode.cpp ActionTableHelper.cpp ConflictItem.cpp MergerInfo.cpp MergerOperator.cpp merge.cpp -o merge -I /usr/include/pcap -lpcap